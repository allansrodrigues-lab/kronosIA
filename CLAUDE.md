...
- **Prospecção fria — rodízio de chips (decisão 24/07, cap atualizado 03/09):** `5519971266736` (Kronos Comercial, ~6 anos) e `5519997237404` (cobaia/pessoal novo, ~3 meses) disparam, **cap de 20 msgs/dia por chip**. `5519971514971` (Kronos Protótipo) está **fora do rodízio agora** — já roda automação própria e está sob risco, não empilhar disparo de prospecção nele. Risco aceito conscientemente pelo Allan: suspensão de 24h (não ban permanente) — se algum chip levar restrição, **parar de disparar por ele imediatamente** e repensar a abordagem, não insistir. Comercial continua sendo o número que sustenta teste de bot sem loop — cautela redobrada nele por isso, não por risco técnico do WhatsApp em si.
