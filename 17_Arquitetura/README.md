...
|---|---|---|
| Planilha CRM própria | `1rXds8GoSGT5zT4LHzn7atNSJObStcxsgq65pUHRWKTY` | ⚠️ criada; falta Allan compartilhar c/ service account + abas |
...
| Voice Agent ElevenLabs | — | pendente |
| Logo (Canva) | `17_Arquitetura/logo_estudio_traco.png` | pendente |
